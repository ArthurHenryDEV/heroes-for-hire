                        ...
                        <form action="php/registrar_usuario.php" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-light">Nome do Herói (Codinome):</label>
                                    <input type="text" name="nome" class="form-control" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-light">Identidade Secreta (Opcional):</label>
                                    <input type="text" name="identidade" class="form-control">
                                </div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label text-light">Super Poderes:</label>
                                <input type="text" name="poderes" class="form-control" placeholder="Ex: Voo, Super Força..." required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label text-light">Afiliação:</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-light">E-mail Oficial:</label>
                                    <input type="email" name="email" class="form-control" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label text-light">Crie sua Senha de Acesso:</label>
                            ...
                            <a href="index.php" class="btn btn-link w-100 mt-2 text-danger" style="text-